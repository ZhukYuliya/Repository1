...
<body>
	...
	<section id="edit">
		...
		<form action="${contextPath}/controller" method="post"
			name="changePassword" onsubmit="return validateChangePasswordForm()">
		...
		<p>
			<fmt:message key="current_contacts" />  ${user.phone}, ${user.email}
		</p>
		<form action="${contextPath}/controller" method="post"
			name="setContacts" onsubmit="return validateSetContactsForm()">

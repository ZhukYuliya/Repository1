...
<body>
	...
	<form action="controller" method="post">
		<input name="first_name" value="${user.firstName}" class="text" /> <input
			name="second_name" value="${user.secondName}" class="text" /> <input
			name="second_name" value="${user.secondName}" class="text" /> 
			<select name="role">

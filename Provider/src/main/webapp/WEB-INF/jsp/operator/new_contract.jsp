...
<body>
	...
	<section id="edit">
		...
		<form action="${contextPath}/controller" method="post"
			name="newContract" onsubmit="return validateNewContractForm()">
			<table>
				<tr>
			...
			<input type="hidden" name="command" value="save_new_contract" /> <input
				type="submit" class="submit"
				value='<fmt:message key="save_button"/> ' />
		</form>
		<span> <c:if test="${not empty param.saveContractMessage}">

...
/**
 * The Class BaseJdbcDAO. The parent class to RequestJdbcDAO, TariffJdbcDAO,
 * UserJdbcDAO. Provides a method to get a conenction and methods for closing
 * statements, rollbacking and releasing connection.
 */
public class BaseJdbcDAO {
	 ...
	 *            the statements
	 */
	public void closeStatementsAndReleaseConnection(Connection connection, Statement... statements) {

...
public class TariffJdbcDAO extends BaseJdbcDAO implements TariffDAO {
	...
	public static final String UPDATE_TARIFF = "UPDATE " + TariffsTable.TARIFFS + " SET " + TariffsTable.NAME + "=?, "
			+ TariffsTable.PRICE + "=?, " + TariffsTable.SPEED + "=?, " + TariffsTable.TRAFFIC + "=?, "
			+ TariffsTable.INACTIVE + "=? WHERE " + TariffsTable.ID + "=?";
	public static final String ADD_TARIFF = "INSERT INTO " + TariffsTable.TARIFFS + " (" + TariffsTable.NAME + ","
			+ TariffsTable.PRICE + "," + TariffsTable.SPEED + "," + TariffsTable.TRAFFIC + "," + TariffsTable.INACTIVE
			+ ") values (?,?,?,?,?)";
	public static final String GET_TARIFF_BY_NAME = "SELECT * FROM " + TariffsTable.TARIFFS + " WHERE "
			+ TariffsTable.NAME + " = ? ";
	public static final String GET_TARIFF_BY_ID = "SELECT * FROM " + TariffsTable.TARIFFS + " WHERE " + TariffsTable.ID
			+ " = ? ";
